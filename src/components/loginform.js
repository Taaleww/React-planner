...
function Login(){
    return (
        <div className="bg-gray-50 min-w-full min-h-full flex items-center justify-center px-10 py-14">
                <div className="flex bg-white rounded-lg shadow-lg overflow-hidden m-4 w-full sm:max-w-md lg:max-w-4xl">
                    <div className="bg-gray-800 w-full hidden lg:block lg:w-1/2 bg-cover py-10"> 
                    <img
                    ...
                    <div className="w-full p-10 lg:w-1/2">
                        ...
                        <form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                            <div className="space-y-1 text-sm">
                                ...
                                <input type="text" name="email" id="email" placeholder="myemail@example.com" className="w-full bg-gray-200 text-gray-700 px-4 py-3 rounded-md block w-full appearance-none border-0 " />
                            </div>
                            <div className="space-y-1 text-sm">
                                <label for="password" className="block text-base font-semibold">Password</label>
                                <input type="password" name="password" id="password" placeholder = "*****************" className="w-full bg-gray-200 text-gray-700 px-4 py-3 rounded-md block w-full appearance-none border-0" />
                                <div className="flex justify-end text-xs text-gray-200 pt-3">
                        ...
                        <p className="text-xs text-center sm:px-6 text-gray-400">Don't have an account?
                            <a href="/" className="underline text-gray-100"> Sign up</a>
                        </p>
                    </div>
                </div>
        </div>
